...
(define sqr (square 
;Desired Expression. Substitute cat for rect sqr to check whether rect or sqr are tall or wide. Do the same for the "tall-wide-square" function, except it can check
if an image is square or not too.
(define tall-or-wide
  (if
